...
public class AssetOpenModeWindow : EditorWindow
{
    ...
    private static CodeOpneMode cgincOpenMode = CodeOpneMode.VSCode; 
    ...
    private void OnGUI()
    {
        ...
        cgincOpenMode = (CodeOpneMode)EditorGUILayout.EnumPopup("cginc", cgincOpenMode);
    ...
    public static bool OpenAsset(int instanceID, int line)
    {
        ...
        else if (fileFullPath.EndsWith(".cginc"))
        {
            return OpenAssetWithEnd(cgincOpenMode, fileFullPath);
        }
        return false;
    }
    ...
    private void Save()
    {
        ...
        EditorPrefs.SetInt("cgincMode", (int)cgincOpenMode);
    }
